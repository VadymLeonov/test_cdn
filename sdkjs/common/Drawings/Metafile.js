...
(function(window, undefined)
{
	...
	CMetafile.prototype =
	{
		...
		{
			this.Memory.WriteByte(CommandType.ctFieldCommandJSON);
			this.Memory.WriteString2(field);
		}
	};
	...
	CDocumentRenderer.prototype =
	{
		...
		drawField: function(field)
		{
			this.m_arrayPages[this.m_lPagesCount - 1].drawField(field);
		}
	};
